...
CREATE TABLE `comments` (
  ...
  `user` varchar(255) COLLATE utf8_swedish_ci NOT NULL,
...
INSERT INTO `comments` (`ID`, `articleID`, `user`, `comment`) VALUES
(1, 1, 'erik', 'a');
...
(1, 'erik', 'erik.hult676@gmail.com', '$2y$10$K5BkcR5YyaO7qhcB3UYqYuIrnD30eGGp3nvVExlqml5A2cUosDAaa');
...
ALTER TABLE `comments`
  ...
  ADD CONSTRAINT `comments_ibfk_3` FOREIGN KEY (`user`) REFERENCES `users` (`username`);
COMMIT;
